                    ...
                    success : function(res) {
                            ...
                            layui.each(res.data, function(index, item){
								...
								if(template_showsales == 1){
									html += '<div style="border-radius: 4px 0 0 4px;text-align:center;padding: 1px;background-color: rgb(57, 61, 73,0.5);color: #FFFFFF;text-align: center;font-size: 10px;position: absolute;right: 1px;bottom: 1px;"></div>';
								}
                                ...
                                html += '<div class="price" style="margin-top: 0.2rem;"><span class="text" style="color: #ff5555;"> <span class="minprice" style="color: #ff5555;font-size: 0.7rem">￥'+item.price+'</span><p style="line-height:0.7rem;height:0.7rem;color:#b2b2b2;font-size:0.6rem;margin-top: .2rem;">'+kucun+'</p><p class="" style="font-size: 0.62rem;position:absolute;margin-left:55%;font-weight: 300;color:#000000;">日销：'+item.sales+' </p> </span>'+buy+'</div>';
                                html += '</div>';
                                html += '</a>';
                                lis.push(html);
                            });

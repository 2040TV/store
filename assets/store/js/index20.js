                ...
                ,done: function(page, next){ //执行下一页的回调
                    ...
                    success : function(res) {
                            ...
                            layui.each(res.data, function(index, item){
                                ...
                                html += '<div style="line-height:0.7rem;height:0.7rem;color:#0000FF;font-size:0.6rem;margin-top: .2rem;">'+shuliang+'<span class="buy" style="color:#fff;background:#ff0000;position: absolute; right: 0">'+sales+'</span></div>';
                                if(item.price <=0){

                ...
                ,done: function(page, next){ //执行下一页的回调
                    ...
                    success : function(res) {
                            ...
                            layui.each(res.data, function(index, item){
                                ...
                                html += '<div class="price" style="margin-top: 0.9rem;"><span class="minprice" style="color: #ff5555;font-size: 0.7rem">￥'+item.price+'</span><p class="" style="font-size: 0.62rem;position:absolute;margin-left:28%;font-weight: 300;color:#000000;">'+kucun+'</p> </span>'+buy+'</div>';
                                html += '</div>';
                                html += '</a>';
                                lis.push(html);
                            });
...
<a class="fui-goods-item" style="width:100%;padding:0 0 0.5em 0" title="1个" href="?mod=shop&amp;tid=1228">
      <div class="detail">
      <img style="width:6em;height:6em;display:block;float:left;" src="/assets/img/spjs/mpz.png" onerror="javascript:this.src='/assets/img/ico_tip.png'" ;="">
          <div class="name" style="color: #000000;">
             福莉名片赞〔一千赞｜可多拍〕</div>
          <div class="price" style="margin-top: 0.9rem;">
               <span class="minprice" style="color: #ff5555;font-size: 0.7rem">￥0.68</span><p class="" style="font-size: 0.62rem;position:absolute;margin-left:28%;font-weight: 300;color:#000000;">库存：充足</p><p class="" style="font-size: 0.62rem;position:absolute;margin-left:55%;font-weight: 300;color:#000000;">月销：20239  </p>

              <span class="buy" style="color:#fff;background:#1492fb;position: absolute;    right: 0;">购买</span>          </div>
      </div>
  </a>

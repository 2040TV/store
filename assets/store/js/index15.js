                ...
                ,done: function(page, next){ //执行下一页的回调
                    ...
                    success : function(res) {
                            ...
                            layui.each(res.data, function(index, item){
                                ...
                                if(item.price <=0){
                                    buy = '<span class="buy" style="background-color: yellowgreen;color:#fff;display: inline-block;height: 1.1rem;line-height: 1rem;color: white;float: right;   padding: 0rem 0.35rem;width: 100%;border-radius: 0.1rem;   border: 1px solid transparent;text-align:center;">领取</span>';
                                }else{
                                    buy = '<span class="buy" style="background: #1492fb;color:#fff;display: inline-block;height: 1.1rem;line-height: 1rem;float: right;padding: 0rem 0.35rem;width:100%;border-radius: 0.1rem;    border: 1px solid transparent;text-align:center;">购买</span>';
                                }

                                if(item.stock == 0){
                                    buy = '<span class="buy" style="background: red;color:#fff;display: inline-block;height: 1.1rem;line-height: 1rem;float: right;padding: 0rem 0.35rem;width:100%;border-radius: 0.1rem;    border: 1px solid transparent;text-align:center;">缺货</span>';
                                }

								if(item.close == 1){
                                    buy = '<span class="buy" style="background: red;color:#fff;display: inline-block;height: 1.1rem;line-height: 1rem;float: right;padding: 0rem 0.35rem;width:100%;border-radius: 0.1rem;    border: 1px solid transparent;text-align:center;">已下架</span>';
                                }

                                html += '<div class="price" style="margin-top: 0.9rem;"><span class="minprice" style="color: #ff5555;font-size: 0.7rem">￥'+item.price+'</span><p class="" style="font-size: 0.62rem;position:absolute;margin-left:28%;font-weight: 300;color:#000000;">'+kucun+'</p><p class="" style="font-size: 0.62rem;position:absolute;margin-left:55%;font-weight: 300;color:#000000;">月销：20466 </p> </span>'+buy+'</div>';
                                html += '</div>';
                                html += '</a>';
                                lis.push(html);
                            });

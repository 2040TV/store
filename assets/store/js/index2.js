                ...
                ,done: function(page, next){ //执行下一页的回调
                    ...
                    success : function(res) {
                            ...
                            layui.each(res.data, function(index, item){
                                ...
                                html += '<div class="price" style="margin-top: 0.2rem;"><span class="minprice" style="color: #ff5555;font-size: 0.7rem">￥'+item.price+'</span><p style="line-height:0.7rem;height:0.7rem;color:#b2b2b2;font-size:0.6rem;margin-top: .2rem;">'+kucun+'</p><p class="" style="font-size: 0.62rem;position:absolute;margin-left:55%;font-weight: 300;color:#000000;">热度：'+item.sales+'</p>'+buy+'</div>';
                                html += '</div>';
                                html += '</a>';
                                lis.push(html);
                            });

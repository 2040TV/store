...
<div id="body">
    ...
    <div class="fui-page-group " style="height: auto">
                            ...
                            <ul>
                                <li><a href="JavaScript:void(0)" onclick="$('.tzgg').show()">
                                        <marquee behavior="alternate">
                                            <span style="color:red">❤️诚邀各级大咖合作共赢-24小时自助商城-售后稳定❤️</span>
                                        </marquee>
                                    </a></li>
                            </ul>
                        </div>
        ...
        <div class="fui-navbar" style="max-width: 650px;z-index: 100;">
            <a href="javascript:void(0);" class="nav-item active"> <span class="icon icon-home "></span> <span class="label">购物首页</span>
            </a>
            ...
            <a href="./?mod=articlelist" class="nav-item "> <span class=" icon icon-service1"></span> <span class="label">更多资源</span>
            </a>

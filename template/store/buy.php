                        ...
                        <div class="pro_right fl">
                            ...
                            <div class="list_tag">
                                <div class="price">
									...
									&nbsp;&nbsp;<button type="button" class="show_daili_price layui-btn layui-btn-warm layui-btn-xs layui-btn-radius "><i class="layui-icon layui-icon-fire"></i>查看代理价格</button>
                                    <?php } ?>
									</span>
                                    <?php echo $stock?>
                                </div>
...
<div id="show_daili_price_html" style="display:none;">
    <div class="price" style="text-align:center;">
        <hr>
        <p class="pay_prices" id="level"><font color="#48d1cc">普通会员售价</font>：<span class="pay_price"><?php echo $price_pt?>元</span></p>
        <p class="pay_prices" id="level"><font color="red">普通代理售价</font>：<span class="pay_price"><?php echo $price_1?>元</span> - 限时免费加入~</p>

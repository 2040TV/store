                ...
                <div class="layui-card-body layui-form layui-form-pane" style="padding: 0.5em">
                    <div style="padding: 0.3em;border-radius: 0.3em;line-height: 2em;height: 2.5em;">
                        <input type="radio" name="pay" value="rmb"
                               title="<p style='width:100%'><img src='./assets/img/rmb.png' width='13px' /> 余额 <span style='color:#999;font-size:0.8em;margin-left:1em'>剩<?php echo $userrow['rmb']?>元</span></p>"><b style="color:red">[推荐]免手续费</b>
                    </div>
                    ...
                    <div style="padding: 0.3em;border-radius: 0.3em;line-height: 2em;height: 2.5em;">
                        <input type="radio" name="pay" <?php echo ($conf['alipay_api'] != 0 ? '' : 'disabled') ?>
                               value="alipay"
                               title="<p style='width:100%'><img src='./assets/img/alipay.png' width='13px' /> 支付宝</p>"><b style="color:red">[推荐]免手续费</b>
                    </div>
                    <?php } ?>
                    ...
                    <div style="padding: 0.3em;border-radius: 0.3em;line-height: 2em;height: 2.5em;">
                        <input type="radio" name="pay" <?php echo ($conf['wxpay_api'] != 0 ? '' : 'disabled') ?> value="wxpay"
                               title="<p style='width:100%'><img src='./assets/img/wxpay.png' width='13px' /> 微信付</p>"><b style="color:red">手续费6%</b>
                    </div>
                    <?php } ?>
                    ...
                    <div style="padding: 0.3em;border-radius: 0.3em;line-height: 2em;height: 2.5em;">
                        <input type="radio" name="pay" <?php echo ($conf['qqpay_api'] != 0 ? '' : 'disabled') ?> value="qqpay"
                               title="<p style='width:100%'><img src='./assets/img/qqpay.png' width='13px' /> QQ钱包</p>"><b style="color:red">手续费3%</b>
                    </div>
                    <?php } ?>
                </div>
				<hr/><b style="color:red">强烈建议使用余额支付可免手续费，余额支付请登录后使用！</b>
				<hr/>小提示：<b style="color:red">如果微信出现无法付款时，您可以把微信的钱转到QQ里，然后使用QQ钱包支付！<a href="./?mod=wx" target="_blank">点击查看教程</a></b>
            </div>
        </div>

...
<head>
    ...
    <title>会员注册 - <?php echo $conf['sitename'];  ?></title>
            ...
            <div class="fui-modal popup-modal in">
                <div class="account-layer login" style="max-height:unset;margin:-13rem 0 0 -7.75rem;">
                        <div class="account-main">
                            ...
                            <div class="account-title">会　员　注　册</div>
                            ...
                            <div class="form-group">
                                ...
                                <font style="color:red;"><i class="fa fa-info-circle"></i>&nbsp;注意此项绑定仅此用于找回密码，不能用于第三方登录绑定！</font>
                            </div>

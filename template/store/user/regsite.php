...
<p></p>
    ...
    <div class="block">
        <div class="block-title">
            ...
            <h2><i class="fa fa-user-plus"></i>&nbsp;&nbsp;<b>自助开通平台</b></h2>
        </div>
				<div class="row text-center">
                    <div class="col-xs-6">
                    <a class="btn btn-block btn-info" href="#about" data-toggle="modal">平台详细介绍</a>
                    </div>
                    <div class="col-xs-6">
                    <a class="btn btn-block btn-info" href="#userjs" data-toggle="modal">平台版本介绍</a>
                    </div>
                </div>
				<br>
                <form>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select name="kind" class="form-control"><option value="1" <?php if($kind==0){?>selected<?php }?>>普通代理(<?php echo $conf['fenzhan_price']?>元)</option><option value="2" <?php if($kind==1){?>selected<?php }?>>高级代理(<?php echo $conf['fenzhan_price2']?>元)</option></select>
                        </div>
						<?php if($conf['fenzhan_regalert']){?><small style="color:red"><i class="fa fa-info-circle"></i>&nbsp;高级代理可以无限免费搭建下级会员并且别人在你下级网站下单你还有提成赚，高级代理的商品比普通代理更便宜，利润更多！</small><?php }?>
                    </div>
					<div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon">
                    ...
                    <div class="form-group">
						...
						<?php if($conf['fenzhan_regalert']){?><small style="color:red"><i class="fa fa-info-circle"></i>&nbsp;例如：XX货源网，XX云商城，XX百货商城，XX换成您想要的名字！</small><?php }?>
                    </div>
                ...
                <table class="table table-borderless table-vcenter">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 20px;">普通代理/高级代理</th>
                        </tr>
                    </thead>
					<tbody>
						<tr class="active">
			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" class="collapsed">代理是怎么获取收益的？</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					...
					<div id="collapseTwo" class="panel-collapse collapse" style="height: 0px;" aria-expanded="false">
						<div class="panel-body">
							代理后台有完整的消费明细和余额信息，后台余额可供您在平台消费，满<?php echo $conf['tixian_min']; ?>元可以在后台提现到QQ钱包微信或者支付宝中。
						</div>
					</div>
				</div>
				<div class="panel panel-default">
				...
				<div class="panel panel-default">
					...
					<div id="collapseFourth" class="panel-collapse collapse" style="height: 0px;" aria-expanded="false">
						<div class="panel-body">
							完全不同，销售提成最高享受商品售价的100%，货源更精，无需注册,无需预存，在线支付，更简单快捷！
						</div>
					</div>
				</div>
				<div class="panel panel-default">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseSix" class="collapsed" aria-expanded="false">那么多货源网有分站，为什么选择你们呢？</a>
						</h4>
					</div>
					<div id="collapseSix" class="panel-collapse collapse" style="height: 0px;" aria-expanded="false">
						<div class="panel-body">
							全网最专业的分销系统，商品齐全、货源稳定、价格低廉、售后保障。实体工作室运营，拥有丰富的人脉和资源，我们的货源全部精挑细选全网性价比最高的，实时掌握货源市场的动态，加入我们，只要你坚持，你不用担心不赚钱，不用担心货源不好，更不用担心我们跑路，我们即使不敢保证你月入上万，在网上赚个零花钱绝对没问题！
						</div>
					</div>
				</div>
			</div>

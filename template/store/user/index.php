...
?>
        <div style="overflow: hidden;height: 9rem;position: relative;background: #fff">
            <div class="headinfo" style="z-index:100;border: none;">
                ...
                <div class="child">
                    ...
                    <?php }else{ ?>
                    <a href="javascript:layer.msg('只有开通代理才可进行提现');" class="external">
                        <div class="btn">提现</div>
                    </a>
                    <?php } ?>
                </div>
    ...
    <?php if($userrow['power']>0){?>
            ...
            <a class="fui-cell external" href="tuiguang.php">
                    ...
                    <div class="fui-cell-text"><p>团队推广文案</p></div>
    ...
    <?php } ?>
        ...
        <a class="fui-cell external" href="record.php">
                ...
                <div class="fui-cell-text"><p>旗下收支明细</p></div>
                <div class="fui-cell-remark"></div>
        </a>
    </div>
<!--     <div class="fui-according-group" id="container" style="display: block;">
    ...
    <div class="fui-cell-group fui-cell-click">
        <a class="fui-cell" href="message.php">
            ...
            <div class="fui-cell-text"><p>站内消息通知</p></div>
        ...
        <a class="fui-cell" href="faq.php">
                ...
                <div class="fui-cell-text"><p>常见问题解答</p></div>
                <div class="fui-cell-remark">           
                </div>
        </a>
        <?php } ?>
...
<!--             <a class="fui-cell external changepwd" href="">
    ...
    <div class="fui-navbar" style="z-index: 100;max-width: 650px;">
        <a href="../" class="nav-item  "> <span class="icon icon-home"></span> <span class="label">购物首页</span> </a>
        <a href="../?mod=query" class="nav-item "> <span class="icon icon-dingdan1"></span> <span class="label">订单客服</span> </a>
        ...
        <a href="../?mod=articlelist" class="nav-item "> <span class=" icon icon-service1"></span> <span class="label">更多资源</span> </a>
        <a href="javascript:void(0);" class="nav-item active"> <span class="icon icon-person2"></span> <span class="label">会员中心</span> </a>
    </div>
</div>

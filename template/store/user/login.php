...
<head>
    ...
    <title>会员登录 - <?php echo $conf['sitename'];  ?></title>
            ...
            <div class="fui-modal popup-modal in">
                <div class="account-layer login" style="max-height:unset;margin:-13rem 0 0 -7.75rem;">
                        <div class="account-main">
                            ...
                            <div class="account-title">会　员　登　录</div>
                        ...
                        <div style="text-align: center;margin-bottom: 5px;color:#999;margin-top: 15px;"> 
                            ...
                            <div style="color:#999;position: relative;top: -12px;width: 100px;background-color: white;margin: auto">            <font style="color:red;">第三方快速注册登录</font></div>

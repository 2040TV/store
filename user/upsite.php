...
<div class="col-sm-6">
    ...
    <div class="panel-heading font-bold" style="background-color: #9999CC;color: white;">高级代理介绍</div>	  
		...
		<div class="panel-body">
			<div class="form-group">
				<div class="input-group">
					...
					<select name="kind" class="form-control"><option value="2">高级代理</option></select>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">

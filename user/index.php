...
<div class="col-lg-4 col-md-6 col-sm-12">
	<div class="panel panel-default">
		...
		<?php if($userrow['power']>0){?>
			...
			<li style="font-weight:bold" class="list-group-item">我的域名：<a href="http://<?php echo $userrow['domain']?>/" target="_blank" rel="noreferrer"><?php echo strpos($userrow['domain'],'58dsw.cn')!==false?'之前的域名被查，请点击后面更换网址':$userrow['domain']?></a><a href="uset.php?mod=site" class="btn btn-info btn-xs pull-right">编辑信息</a></li>
